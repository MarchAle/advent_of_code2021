...
void	add_grid(std::list<Grid> &grids, std::ifstream &input)
{
	std::string line;
...
int main()
{
	...
	{
		std::list<Grid>::iterator end_grids = grids.end();
		for (std::list<Grid>::iterator gridIt = grids.begin(); gridIt != end_grids; gridIt++)
		{
